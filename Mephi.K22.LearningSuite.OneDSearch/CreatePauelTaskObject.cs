// Type: Mephi.K22.LearningSuite.OneDSearch.CreatePauelTaskObject
...
{
  public class CreatePauelTaskObject : BaseTaskObjectControl
  {
    ...
    public CreatePauelTaskObject(DihTaskObject to)
    {
    ...
    public CreatePauelTaskObject(DihTaskObject to, bool enableEdit)
    {
      this.InitializeComponent();
      if (to != null)
      {
      ...
      this.tbName.ReadOnly = this.tbEps.ReadOnly = this.tbFunc.ReadOnly = true;
    ...
    private void InitializeComponent()
    {
      ...
      this.tbFunc.Location = new System.Drawing.Point(124, 176);
      ...
      this.Name = "CreatePauelTaskObject";
      this.Size = new Size(396, 216);
    ...
    public override BaseTaskObject GetTaskObject()
    {
      ...
      try
      {
        dihTaskObject = new DihTaskObject(this.tbName.Text, 0.0, 0.0, this.tbFunc.Text, double.Parse(this.tbEps.Text), this.rbMin.Checked ? ExtremumType.min : ExtremumType.max, this.rbPrecise.Checked ? DihTaskObject.StopTypeEnum.precise : DihTaskObject.StopTypeEnum.steps, int.Parse(this.tbStepCount.Text));
      }
      catch (Exception ex)
      {
