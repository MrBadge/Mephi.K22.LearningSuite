// Type: Mephi.K22.LearningSuite.OneDSearch.Base.SegmentLength
...
{
  public class SegmentLength : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.SuspendLayout();
      this.groupBox1.Controls.Add((Control) this.tbLen);
      ...
      this.tbLen.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this.tbLen.Location = new System.Drawing.Point(52, 12);
      this.tbLen.Name = "tbLen";
      this.tbLen.Size = new Size(228, 20);
      ...
      this.Text = "Задайте длину отрезка";
